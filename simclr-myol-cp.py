...
if __name__ == '__main__':
    ...
    if args.mixup:
        model_name = 'simclr_myol_{}_{}_{}_alpha{}_{}'.format(args.optim, args.lr, args.weight_decay, args.alpha, args.seed)
    else:
        model_name = 'simclr_byol_{}_{}'.format(args.optim, args.seed)
    ...
    if args.optim == 'adam':
        ...
        optimizer = optim.SGD(learner.parameters(), lr=args.lr, momentum=0.9, weight_decay=args.weight_decay)
    least_loss = np.Inf
